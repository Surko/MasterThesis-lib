...
public abstract class Individual implements Serializable {
	...
	/**
	 *  Fitness value which is in some way combination of fitness values in array.
	 *  Type of combination can be sum, weighted sum or other mean of view on 
	 *  multi criterial fitness functions.
	 */
	protected double complexFitness = Double.MIN_VALUE;
	/** true/false depending whether individual has changed or hasn't*/
	protected boolean hasChanged = true; 
	
	/**
	 * Method which will set value of fitness into array of fitnesses in this object.
	 * Index should not exceed amount of elements in this array.
	 * @param index index at which is the element save
	 * @param fitness value of fitness 
	 * @see FitnessFunction
	 */
	 ...
	 * @param complexFitness value of this complex fitness
	 */
	 ...
	 * @param index from which we take fitness value
	...
	/**
	 * Make this individual be recognized as the one that has changed. If the individual changed
	 * than the computation of fitness is inevitable.
	 */
	public void change() {
		hasChanged = true;
	}
	...
	/**
	 * Make this individual be recognized as the one that hasn't changed. Used for speeding
	 * up the computation of fitness values.
	 */
